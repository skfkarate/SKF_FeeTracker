...
export default function CustomPage() {
  ...
  const tabFromUrl = searchParams.get("tab") as CustomTab | null;
  const [activeTab, setActiveTab] = useState<CustomTab>(tabFromUrl === "removals" ? "removals" : "dues");

  useEffect(() => {
    const tab = searchParams.get("tab") as CustomTab | null;
    if (tab === "dues" || tab === "removals") {
      setActiveTab(tab);
    }
  }, [searchParams]);
